      ...
      <div className="hero-content flex-col lg:flex-row-reverse">
        ...
        <div>
          ...
          <p className="py-4 text-lg">
            ...
            user-friendly, and interactive web applications. My core skills lie
            in creating dynamic and responsive websites using modern frontend
            technologies. I focus on writing clean, efficient, and maintainable
            code. I enjoy turning ideas into real-world projects and
